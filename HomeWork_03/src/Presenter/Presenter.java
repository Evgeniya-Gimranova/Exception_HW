package HomeWork_03.src.Presenter;
...
import HomeWork_03.src.Model.ParsingDataStringException;
import HomeWork_03.src.Model.DataChecker;
    ...
    public void start() {
        ...
        do {
            String input = view.getInput(
                    "Введите данные через пробел (Фамилию Имя Отчество НомерТелефона ДатуРождения Пол), или Exit для прекращения программы:");
